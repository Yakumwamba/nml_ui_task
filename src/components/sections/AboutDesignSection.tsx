...
export default function AboutDesignSection() {
  return (
    <section className='flex h-auto  w-full flex-col bg-white pt-44 lg:items-start'>
      {/* About design */}
      <div className=' mr-10 flex w-auto gap-6 pb-20 sm:ml-10 sm:scale-95  sm:flex-col sm:items-start md:ml-16 md:mr-16 lg:mx-52 lg:flex-row lg:items-center'>
        <UnionIcon />
      ...
      <div className='flex  justify-around pb-[90px] pt-6 sm:ml-16 sm:mr-10 sm:scale-110 sm:flex-col sm:items-start sm:gap-5  md:ml-32 lg:mx-56 lg:w-auto  lg:scale-100 lg:flex-row  lg:items-center'>
        {/* Powerful */}
        <div className='flex flex-col'>
          <p className='text-2xl font-semibold'>Powerful</p>
          <p className='font-poppins w-auto pt-10 text-start text-base  font-normal'>
